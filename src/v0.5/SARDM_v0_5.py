...
class MetapopConfiguration :
    ...
    def __init__(self, user_app_data_dir, config_file) :
        ...
        common_fields = ['Time', 'Mean-1SD', 'Mean', 'Mean+1SD']
        common_calculations = { 'fields' : common_fields, 'calculations' : { 'Mean-1SD' : { 'field' : 'Average', 'calculate' : 'mean-1*stdev' }, 'Mean' : { 'field' : 'Average', 'calculate' : 'mean' }, 'Mean+1SD' : { 'field' : 'Average', 'calculate' : 'mean+1*stdev' } } }
        ...
        self.result_plot_view_details['Predicted Abundance'] = { 'plot_type' : 'time_series_interval',
                                                                 'plot_title' : 'Predicted Abundance',
                                                                 'x_data' : 'Time',
                                                                 'y_data' : { 'lower' : 'Mean-1SD', 'mid' : 'Mean', 'upper' : 'Mean+1SD' },
                                                                 'x_label' : 'Time',
                                                                 'y_label' : 'Mean '+u'\u00B1'+' 1 Standard Deviation' }
        self.result_plot_view_details['Predicted Metapopulation Occupancy'] = {  'plot_type' : 'time_series_interval',
                                                                                 'plot_title' : 'Predicted Metapopulation Occupancy',
                                                                                 'x_data' : 'Time',
                                                                                 'y_data' : { 'lower' : 'Mean-1SD', 'mid' : 'Mean', 'upper' : 'Mean+1SD' },
                                                                                 'x_label' : 'Time',
                                                                                 'y_label' : 'Mean '+u'\u00B1'+' 1 Standard Deviation' }
...
class ApplicationGUI(tk.Frame) :
    ...
    def createResultsPlotWindow(self) :
        ...
        tk.Button(self.view_results_plot_frame, text='Save', anchor=tk.CENTER, command=self.saveFigureViaToolbar).grid(row=1, column=0, padx=0, pady=5)
    ...
    def createResultsPlotFigure(self) :
        ...
        plot_type = result_plot_config['plot_type']
        plot_title = result_plot_config['plot_title']
        x_data = result_plot_data[result_plot_config['x_data']]
        if plot_type == 'time_series_interval' :
            y_data = result_plot_data[result_plot_config['y_data']['mid']]
            lower_data = result_plot_data[result_plot_config['y_data']['lower']]
            upper_data = result_plot_data[result_plot_config['y_data']['upper']]
        else : # no others so far
            y_data = result_plot_data[result_plot_config['y_data']]
        x_label = result_plot_config['x_label']
        y_label = result_plot_config['y_label']
